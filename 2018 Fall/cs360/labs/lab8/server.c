...
main(int argc, char *argv[])
{
   ...
   while(1){
     ...
     while(1){
      ...
      if (!strcmp(inputArray[0], "mkdir")) mkdir(inputArray[1], 0755);
      else if (!strcmp(inputArray[0], "rmdir")) rmdir(inputArray[1]);
      else if (!strcmp(inputArray[0], "rm")) unlink(inputArray[1]);
